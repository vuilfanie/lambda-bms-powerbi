...
api_request = APIRequest('https://api.bmsemea.kaseya.com/v2/security')
response = api_request('POST', '/authenticate', data={'UserName': 'apiuser', 'Password': 'BStr@nd67.', 'GrantType': 'password', 'Tenant': 'gravit8 it'})
